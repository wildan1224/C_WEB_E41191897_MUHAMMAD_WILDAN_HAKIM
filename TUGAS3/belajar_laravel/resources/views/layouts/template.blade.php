...
<head>
  ...
  <link href="{{assets('frontend/assets/vendor/icofont/icofont.min.css')}}" rel="stylesheet">
  <link href="{{assets('frontend/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet')}}">
  <link href="{{assets('frontend/assets/vendor/venobox/venobox.css" rel="stylesheet')}}">
  <link href="{{assets('frontend/assets/vendor/line-awesome/css/line-awesome.min.css" rel="stylesheet')}}">
  <link href="{{assets('frotend/assets/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet')}}">
